...
The [CO~2~ case study](https://mrne222-sp25.github.io/slides/project-example/project-example.html) is an example project to give you a sense of what constitutes a great final product.
...
Below is a list of data repositories that might be of interest to browse. You're not limited to these resources - you are welcome to identify your own datasets as well.

-   [Environmental Data Initiative Data Portal](https://portal.edirepository.org/nis/home.jsp)
-   [National Ecological Observatory Network Data Portal](https://www.neonscience.org/data)
...
-   [CoastalWiki list of marine databases](https://www.coastalwiki.org/wiki/Marine_data_portals_and_tools)
...
-   [NOAA One Stop data portal](https://data.noaa.gov/onestop/)
-   [NOAA National Centers for Environmental Information](https://www.ncei.noaa.gov/)
-   [Australian Institute of Marine Science data](https://www.aims.gov.au/data#:~:text=AIMS%20network%20of%20weather%20stations,climate%20events%20in%20Northern%20Australia.)
-   [German Marine Data Portal](https://marine-data.de/)
-   [French Marine Data Portal](https://www.ifremer.fr/en/research-infrastructures/marine-data-portal)
...
-   Question and data: The research question is well-designed and the data are relevant to the research question.
-   Methods: Appropriate analytical methods are used to address the research question.
-   Creativity and critical thought: The project is carefully designed and implemented, and limitations/shortcomings is thoughtfully discussed.
-   Professional polish: The figures and writing follows best practices (be free of errors, well-organized, polished, etc.).
-   Syntax and style: The report uses [R Markdown syntax](https://www.rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf) formatting to improve clarity and polish (e.g., plain text, code chunks, bulleted lists, headings, embedded hyperlinks, inline code, etc.). Code follows [R Style Guide](http://adv-r.had.co.nz/Style.html).
-   Time management: The team equitably distributes time spent on the project.
-   Collaboration: The team works as a cohesive unit to collaboratively complete the project. This involves good communication and defining clear expectations for each other. Each team member makes regular, substantive commits throughout the project timeline.
-   Reproducibility: .qmd file renders, indicating that the entire analysis can be run by an independent user in a new R Studio session; final rendered file is pushed to GitHub. README file contains a project summary and metadata description.
-   File organization: Repo only includes report, proposal, and data files used in the analysis. Does not include extra data or code files not used in the final analysis.

## Tips

-   You're working in the same repo as your teammates now, so merge conflicts will happen and that's fine. Try to avoid conflicts by **pulling every time you start a new R session.** Commit and push your work often. And ask questions when stuck.
...
-   Make sure to render your final report, commit it, and then push it to GitHub!
